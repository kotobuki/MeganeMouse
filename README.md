...
このメガネ型マウスは、頭の動きでカーソルを移動します。オプションで外部スイッチを接続して左右のマウスボタン操作を行うことができます。また、通常のマウス／トラックパッド／外部のスイッチなど、使いやすいものを組み合わせることもできます。
...
- 頭の動きを精密なカーソル移動に変換
- 外部スイッチ対応：左右のマウスボタン用スイッチ接続可能（GPIO 1と2）
...
- **外部スイッチ**：左右のマウスボタン操作用
  - 左ボタン：押している間だけ回路が閉じるスイッチをGPIO 1とGNDの間に接続
  - 右ボタン：押している間だけ回路が閉じるスイッチをGPIO 2とGNDの間に接続
